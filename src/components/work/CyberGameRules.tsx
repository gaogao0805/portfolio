...
const roles = {
  company: {
    zh: "公司",
    en: "Company",
    image: "/images/cdn/cyber-role-company.wj9fiwlfl.webp",
  },
  user: {
    zh: "网民",
    en: "User",
    image: "/images/cdn/cyber-role-user.2rvu85911f.webp",
  },
  hacker: {
    zh: "黑客",
    en: "Hacker",
    image: "/images/cdn/cyber-role-hacker.60uy4swinz.webp",
  },
} as const;
          ...
          <div className="mt-8 grid gap-5 sm:mt-10 sm:gap-6 lg:grid-cols-[1.7fr_0.78fr_0.78fr] lg:items-stretch">
              ...
              <div className="mt-5 grid flex-1 gap-5 md:mt-6 md:grid-cols-[1fr_auto_170px] md:items-center md:gap-6">
                  ...
                  <div className="grid grid-cols-2 gap-2.5 sm:gap-3">
                    <div className="min-w-0 overflow-hidden border border-[#f7aa3a]/70 p-2 sm:p-3">
                      <div className="relative mx-auto h-36 w-[103px] max-w-full sm:h-44 sm:w-[126px]">
                        <Image src="/images/cdn/cyber-card-user.92qu5zy035.webp" alt={isZh ? "网民身份卡" : "User role card"} fill sizes="(max-width: 639px) 103px, 126px" className="object-contain" />
                      </div>
                      <p className="mt-2 text-center text-xs sm:mt-3 sm:text-sm">{isZh ? "网民 2–3 人" : "Users, 2–3 players"}</p>
                    </div>
                    <div className="min-w-0 overflow-hidden border border-[#f7aa3a]/70 p-2 sm:p-3">
                      <div className="relative mx-auto h-36 w-[103px] max-w-full sm:h-44 sm:w-[126px]">
                        <Image src="/images/cdn/cyber-card-hacker.5flaih27lf.webp" alt={isZh ? "黑客身份卡" : "Hacker role card"} fill sizes="(max-width: 639px) 103px, 126px" className="object-contain" />
                      </div>
                ...
                <div className="mx-auto w-fit md:mx-0">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-x-5 gap-y-4">
                    <Token src="/images/cdn/cyber-token-user.96ag3qrh1m.webp" count="×9" alt={isZh ? "网民普通信息块" : "User information token"} />
                    <Token src="/images/cdn/cyber-token-user.96ag3qrh1m.webp" count="×3" alt={isZh ? "网民高级信息块" : "Advanced user information token"} outlined />
              ...
              <div className="grid flex-1 grid-rows-[168px_44px_1fr] pt-5 sm:grid-rows-[196px_52px_1fr] sm:pt-6">
                <div className="flex items-start justify-center">
                  <div className="relative h-40 w-[114px] max-w-full sm:h-44 sm:w-[126px]">
                    <Image src="/images/cdn/cyber-card-company.491z9vdb05.webp" alt={isZh ? "公司身份卡" : "Company role card"} fill sizes="(max-width: 639px) 114px, 126px" className="object-contain" />
                  </div>
                </div>
            ...
            <section className="flex min-w-0 flex-col border border-white/15 p-4 sm:p-6">
              ...
              <div className="grid flex-1 grid-rows-[168px_44px_1fr] pt-5 sm:grid-rows-[196px_52px_1fr] sm:pt-6">
                <div className="flex items-start justify-center">
                  <div className="relative h-40 w-[114px] max-w-full sm:h-44 sm:w-[126px]">
                    <Image src="/images/cdn/cyber-card-moderator.1lcizik9o2.webp" alt={isZh ? "智慧大脑主持人身份卡" : "Moderator role card"} fill sizes="(max-width: 639px) 114px, 126px" className="object-contain" />
                  </div>
                </div>
                <p className="flex items-center justify-center text-center text-sm">
