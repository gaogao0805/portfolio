...
const lowInformationBlocks: InformationBlock[] = [
  { key: "low-1223", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/low-1223.1sfqv0ir8v.webp", label: "Low-level information block" },
  { key: "low-1224", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/low-1224.1ow4xapoj2.webp", label: "Low-level information block" },
  { key: "low-1227", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/low-1227.9ddnz7pkdm.webp", label: "Low-level information block" },
  { key: "low-1228", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/low-1228.3d5huhfyp8.webp", label: "Low-level information block" },
  { key: "low-1234", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/low-1234.51euro68vf.webp", label: "Low-level information block" },
  { key: "low-1235", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/low-1235.6wrfkaioh4.webp", label: "Low-level information block" },
  { key: "low-1236", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/low-1236.8okef721d1.webp", label: "Low-level information block" },
  { key: "low-1237", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/low-1237.45idc7wkfd.webp", label: "Low-level information block" },
];

const highInformationBlocks: InformationBlock[] = [
  { key: "high-1225", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/high-1225.8hh6jreqv6.webp", label: "High-level information block" },
  { key: "high-1226", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/high-1226.9gx9wxhi15.webp", label: "High-level information block" },
  { key: "high-1229", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/high-1229.96ag3s29vl.webp", label: "High-level information block" },
  { key: "high-1233", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/high-1233.lwfmespkw.webp", label: "High-level information block" },
  { key: "high-1238", src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/high-1238.7ehh8viwzj.webp", label: "High-level information block" },
];

const scoreTables: ScoreTable[] = [
  {
    key: "credit-score-table",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/credit-score-table.60uy4ty9iz.webp",
    width: 1094,
    height: 1094,
  ...
  },
  {
    ...
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/information-value-score-table.2dpehb2h1b.webp",
    width: 1341,
    height: 493,
...
const roleCards: CardItem[] = [
  {
    ...
    zh: "黑客",
    en: "Hacker",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-character-hacker.64ek2hpqlq.webp",
    description: {
  ...
  },
  {
    ...
    zh: "网民",
    en: "User",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-character-user.4cll7l6dpl.webp",
    description: {
  ...
  },
  {
    ...
    zh: "公司",
    en: "Company",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-character-company.pg1k2al7z.webp",
    description: {
  ...
  },
  {
    ...
    zh: "智慧大脑",
    en: "Wisdom Brain",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-character-brain.9kgvukzdo0.webp",
    description: {
...
const roleSkillCards: CardItem[] = [
  {
    ...
    zh: "防火墙卡",
    en: "Firewall card",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-ability-firewall.3yf5gpehvw.webp",
    description: {
  ...
  },
  {
    ...
    zh: "攻击卡",
    en: "Attack cards",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-ability-attack.3d5huf3mk6.webp",
    description: {
  ...
  },
  {
    ...
    zh: "小道消息卡",
    en: "Hearsay",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-ability-hearsay.1e9b42y48k.webp",
    description: {
...
const privacyCards: CardItem[] = [
  {
    ...
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-privacy-low-browsing-history.1app6dtv18.webp",
    description: {
  ...
  },
  {
    ...
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-privacy-low-network-info.et7qxk6l7.webp",
    description: {
      zh: "低等级隐私协议卡。用户提供低等级信息，计 1 个信息点。",
      en: "Lower-level privacy agreement card. The user provides low-level information worth 1 information point.",
    },
  },
  {
    ...
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-privacy-high-address.32io1ad7xc.webp",
    description: {
  ...
  },
  {
    ...
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-privacy-high-identity.2ksmcpbuca.webp",
    description: {
...
const ordinaryCards: CardItem[] = [
  {
    ...
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-skill-perish-together.8dxkm04qdj.webp",
    description: {
  ...
  },
  {
    ...
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-skill-average-info.83aqsupi89.webp",
    description: {
      zh: "所有网民的信息点会被平均分配。",
  ...
  },
  {
    ...
    zh: "防火墙卡",
    en: "Firewall card",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-skill-firewall.2oc8afacui.webp",
    description: {
  ...
  },
  {
    ...
    zh: "替换卡",
    en: "Replace card",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-skill-replace.2vfg5uwia0.webp",
    description: {
      zh: "可以和另一位网民交换手中全部卡牌。",
...
const eventCards: CardItem[] = [
  {
    ...
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-event-security-vulnerability.1e9b43d08m.webp",
    description: {
  ...
  },
  {
    ...
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-event-photo-leak.9rk3q10f3r.webp",
    description: {
  ...
  },
  {
    ...
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-event-privacy-law.7axvb3tj78.webp",
    description: {
  ...
  },
  {
    ...
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-event-awareness.99u21fz1iw.webp",
    description: {
...
const finalShowcaseImages = [
  {
    key: "board",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-showcase-board.99u21hatxl.webp",
    alt: {
  ...
  {
    key: "cards",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-showcase-cards.2h90f0kmiv.webp",
    alt: {
  ...
  {
    key: "hands",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-showcase-hands.4xv8txrifc.webp",
    alt: {
  ...
  {
    key: "manual",
    src: "https://cdn.jsdelivr.net/gh/gaogao0805/picx-images-hosting@master/cyber-showcase-manual.2h90f0kmiu.webp",
    alt: {
